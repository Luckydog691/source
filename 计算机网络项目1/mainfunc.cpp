#include "mainfunc.h"
//读入string,导出Movie
void ExportMovie(string inputaddress, string movaddress, int framedis, int upplimit, int framerate)
{
	...
	Mat_to_movie(movaddress, "image/pic", pictflow, framedis, 8, upplimit ,framerate);//pict转视频，最后参数是放大倍数
}
